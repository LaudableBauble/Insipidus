...
namespace InsipidusEngine
{
    ...
    class GameplayScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            Sprite s1 = new Sprite(pokemon1.Sprite, @"Pokemon\Pansear_Icon[1]", new Vector2(100, 300), 1, 1, 0, 0, 0, "");
            Sprite s2 = new Sprite(pokemon1.Sprite, @"Pokemon\Snivy_Icon[1]", new Vector2(400, 300), 1, 1, 0, 0, 0, "");
